...
namespace HashBrowns.Symmetric
{
    ...
    public class DES : SymmetricBaseClass
    {
        /// <summary>
        /// Gets the name.
        /// </summary>
        /// <value>The name.</value>
        public override string Name => SymmetricAlgorithms.DES;

        /// <summary>
        /// Gets the algorithm.
        /// </summary>
        /// <returns>The algorithm to use.</returns>
        protected override SymmetricAlgorithm GetAlgorithm() => new DESCryptoServiceProvider();
    }
}