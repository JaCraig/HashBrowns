...
namespace HashBrowns.Symmetric
{
    ...
    public class TripleDES : SymmetricBaseClass
    {
        /// <summary>
        /// Gets the name.
        /// </summary>
        /// <value>The name.</value>
        public override string Name => SymmetricAlgorithms.TripleDES;

        /// <summary>
        /// Gets the algorithm.
        /// </summary>
        /// <returns>The algorithm to use.</returns>
        protected override SymmetricAlgorithm GetAlgorithm() => new TripleDESCryptoServiceProvider();
    }
}